...
impl Solver {
    ...
    fn solve(&mut self) {
        ...
        while i < N {
            let s = S[i];
            if s == 'd' {
                if i + 10 < N && S[i..i + 11].iter().join("") == "dreameraser" {
                    i += 11;
                } else if i + 9 < N && S[i..i + 10].iter().join("") == "dreamerase" {
                    i += 10;
                } else if i + 6 < N && S[i..i + 7].iter().join("") == "dreamer" {
                    i += 7;
                } else if i + 4 < N && S[i..i + 5].iter().join("") == "dream" {
                    i += 5;
                } else {
                    println!("NO");
                    return;
                ...
                if i + 5 < N && S[i..i + 6].iter().join("") == "eraser" {
                    i += 6;
                } else if i + 4 < N && S[i..i + 5].iter().join("") == "erase" {
                    i += 5;
                } else {
                    println!("NO");
                    return;
